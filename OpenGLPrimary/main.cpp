...
#pragma endregion
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glm::vec3 lightColor = glm::vec3(0.8f, 0.5f, 0.1f);
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			Material* myMaterial = new Material(glm::vec3(0.3f, 0.4f, 0.2f),glm::vec3(0.6f, 0.3f, 0.2f),glm::vec3(0.6f, 0.5f, 0.3f),32);
